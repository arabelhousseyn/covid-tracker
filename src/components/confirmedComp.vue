    ...
    <div class="confirmed rightItem boxColor borderBox">
        ...
        <div class="boxRight">
            ...
            <div v-if="tog2">
                ...
                <span class="country">{{casee.Country}}</span> <span class="red value">{{casee.TotalConfirmed | formatNumber}} / + {{casee.NewConfirmed | formatNumber}}</span> </p>
            </div>
            <div v-else>
...
export default {
    ...
    created()
    {
        ...
        this.confirmed = this.$store.state.en.one
        this.newConfirmed = this.$store.state.en.four
        this.valueConfirmed = this.$store.state.confirmed
        this.valuenewConfirmed = this.$store.state.newConfirmed
